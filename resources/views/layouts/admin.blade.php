  ...
  <div class="wrapper">
      ...
      {{-- <a href="{{ route('home.index') }}" class="brand-link"> --}}
        ...
        <div class="sidebar">
          ...
          <div class="user-panel mt-3 pb-3 mb-3 d-flex">
            <div class="image">
                <svg width="32px" height="32px" viewBox="-1.5 -1.5 18.00 18.00" fill="none"
                  xmlns="http://www.w3.org/2000/svg" stroke="#fffafa">
                  <g id="SVGRepo_bgCarrier" stroke-width="0"
                    transform="translate(1.5749999999999993,1.5749999999999993), scale(0.79)">
            ...
            <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
              ...
              <li class="nav-item">
                <a href="{{route('dashboard.index')}}"
                  class="{{ request()->is('panel/admin') ? 'nav-link active' : 'nav-link' }}">
              ...
              <li class="nav-item">
                <a href="{{route('paket.index')}}"
                  class="{{ request()->is('panel/paket*') ? 'nav-link active' : 'nav-link' }}">
              ...
              <li class="nav-item">
                <a href="{{route('kupon.index')}}"
                  class="{{ request()->is('panel/kupon*') ? 'nav-link active' : 'nav-link' }}">
              ...
              <li class="nav-item">
                <a href="{{route('order.index')}}"
                  class="{{ request()->is('panel/order*') ? 'nav-link active' : 'nav-link' }}">
                  <i class="nav-icon fas fa-digital-tachograph"></i>
                  <p>
                    test midtrans
                  </p>
              ...
              {{-- <li class="{{ request()->is('panel/pembayaran*') ? 'nav-item menu-open' : 'nav-item' }}">
                ...
                <ul class="nav nav-treeview">
                  <li class="nav-item">
                    <a href="{{route('pembayaran.index')}}"
                      class="{{ request()->is('panel/pembayaran/bukti*') ? 'nav-link active' : 'nav-link' }}">
                  ...
                  <li class="nav-item">
                    <a href="{{route('pembayaran.index')}}"
                      class="{{ request()->is('panel/pembayaran/midtrans*') ? 'nav-link active' : 'nav-link' }}">
                      <i class="nav-icon far fa-circle"></i>
                      <p>
                        Midtrans
                      </p>
              ...
              {{-- <li class="{{ request()->is('panel/partner*') ? 'nav-item menu-open' : 'nav-item' }}">
                <a href="#" class="nav-link">
                ...
                <ul class="nav nav-treeview">
                  <li class="nav-item">
                    <a href=""
                      class="{{ request()->is('panel/partner/mc*') ? 'nav-link active' : 'nav-link' }}">
                      <i class="nav-icon far fa-circle"></i>
                      <p>
                        MC
                      </p>
                  ...
                  <li class="nav-item">
                    <a href=""
                      class="{{ request()->is('panel/partner/band*') ? 'nav-link active' : 'nav-link' }}">
                      <i class="nav-icon far fa-circle"></i>
                      <p>
                        Band
                      </p>
                  ...
                  <li class="nav-item">
                    <a href=""
                      class="{{ request()->is('panel/partner/penyanyi*') ? 'nav-link active' : 'nav-link' }}">
                      <i class="nav-icon far fa-circle"></i>
                      <p>
                        Penyanyi
                      </p>
                  ...
                  <li class="nav-item">
                    <a href=""
                      class="{{ request()->is('panel/partner/aproval') ? 'nav-link active' : 'nav-link' }}">
                      <i class="nav-icon far fa-circle"></i>
                      <p>
                        Aproval
                      </p>
              ...
              <li class="nav-item">
                <a href="{{route('setting.index')}}"
                  class="{{ request()->is('partner') ? 'nav-link active' : 'nav-link'}}">
    ...
    <footer class="main-footer">
      ...
      {{-- <strong>Copyright &copy;
        <?php $cpy = date('Y'); echo $cpy; ?><a href="{{ route('home.index') }}"> PT. Solusi Pasti Untuk Indonesia</a>.
      </strong> All rights reserved. --}}
      <strong>Copyright &copy;
        <?php $cpy = date('Y'); echo $cpy; ?><a href="#"> PT. Solusi Pasti Untuk Indonesia</a>.
      </strong> All rights reserved.
    </footer>
...
<script>
  $(document).ready(function(){
    $("#angka").keyup(function(){
      $(this).maskNumber({integer: true, thousand: "."})
    })
  })
  </script>
  <script>
